...
export function LandingPage() {
  ...
  const { addToCart, toggleFavorite, isFavorite, hasProductInCart } =
    useCartDrawer();
  ...
  >([]);
  const [bookingStep1Focus, setBookingStep1Focus] = useState<
    "all" | "photoshoot"
  >("all");
  ...
  const homeShopProducts = useMemo(
    () => visibleProducts.slice(0, HOME_SHOP_PREVIEW),
    [visibleProducts],
  );

  const preferredDateLabel = useMemo(
    () => formatBookingDateLabel(preferredDateIso),
    [preferredDateIso],
  );
  ...
  const stepCircle = (i: number) => {
    if (formStep === i) return "border-tle-pink bg-tle-pink text-white";
      ...
      <div ref={wrapRef} className="w-full">
        ...
        >
          ...
          <div className="relative z-[5] flex max-lg:items-center max-lg:text-center flex-col justify-center px-6 pt-28 pb-16 sm:px-12 lg:items-start lg:text-left lg:pl-20 lg:pr-16 lg:pt-32 lg:pb-20">
            ...
            <div className="mb-8 flex max-lg:justify-center items-center gap-3.5">
              <div className="flex">
                {[
                  {
                    src: "/Imagereviews4.jpeg",
                    alt: "Client makeup look review",
                  },
                  {
                    src: "/Imagereviews5.jpeg",
                    alt: "Client makeup look review",
                  },
                  {
                    src: "/Imagereviews6.jpeg",
                    alt: "Client makeup look review",
                  },
                ].map((item, i) => (
                  <img
              ...
              <div className="text-left leading-snug max-lg:text-center">
                <strong className="block text-[13px] font-semibold text-tle-ink">
                  100+ happy clients
                </strong>
                <span className="text-[11.5px] text-tle-muted">
                  <span className="text-[#E8A23C]">★★★★★</span> &nbsp;4.9 across
                  all services
                </span>
              </div>
            </div>
            ...
            <div className="absolute bottom-8 left-1/2 z-[5] flex -translate-x-1/2 items-center gap-3.5 sm:left-12 sm:translate-x-0 lg:left-20">
              ...
              <span className="text-[10px] font-medium tracking-[0.2em] text-tle-faint uppercase">
                Scroll to explore
              </span>
            </div>
          </div>
          ...
          >
            ...
            <div
              className="pointer-events-none absolute inset-x-0 bottom-0 z-[3] h-32 bg-gradient-to-t from-black/40 to-transparent lg:hidden"
              aria-hidden
            />
        ...
        <section
          className={`${revealCls} px-4 py-16 sm:px-6 sm:py-20 md:px-16 lg:px-20`}
          id="shop"
        >
          <div className="mb-10 flex flex-wrap items-end justify-between gap-6 md:mb-12">
            <div>
              ...
              <h2 className="font-sans text-[clamp(1.875rem,3.5vw,3rem)] leading-tight font-semibold text-tle-ink">
                Shop What&apos;s{" "}
                <em className="font-sans font-medium italic text-tle-pink">
                  Trending
                </em>
              </h2>
            </div>
            <div className="flex flex-wrap gap-2">
              <button
                type="button"
                className={pillCls(filterGender === "all")}
              ...
              <button
                type="button"
                className={pillCls(filterGender === "her")}
                onClick={() => setFilterGender("her")}
              >
                For Her
              </button>
              <button
                type="button"
                className={pillCls(filterGender === "him")}
                onClick={() => setFilterGender("him")}
              >
                For Him
              </button>
              <button
          ...
          {catalogSearch ? (
            <div className="mb-6 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-tle-pink/15 bg-tle-blush/40 px-4 py-3 text-[13px] text-tle-ink">
              <span>
                Showing results for{" "}
                <strong className="font-semibold text-tle-pink">
                  &ldquo;{searchParams.get("q")?.trim()}&rdquo;
                </strong>
              </span>
              <button
                type="button"
                ...
                {products.length === 0 ? (
                  <>
                    ...
                    <p className="mt-2 text-sm text-tle-muted">
                      Check back soon, or open the shop to see the full range
                      when it&apos;s live.
                    </p>
                    <Link
                      to="/shop"
        ...
        <div
          className={`${revealCls} px-4 pb-20 md:px-10 lg:px-16`}
          id="makeup"
        >
        ...
        <section
          className={`${revealCls} grid items-center gap-12 bg-tle-cream px-6 py-20 md:gap-20 md:px-16 lg:grid-cols-2 lg:px-20`}
          id="about"
        >
          <div className="relative">
            ...
            <div className="absolute top-8 -left-8 rounded-[18px] bg-tle-pink px-6 py-5 text-white shadow-[0_20px_44px_rgba(196,105,141,0.32)] max-md:hidden">
              <div className="font-sans text-[44px] font-bold leading-none">
                100+
              </div>
              <div className="text-[11px] font-medium tracking-wide opacity-80">
                Happy Clients
              </div>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  desc: "Only the finest make our shelves",
                },
                {
                  icon: "schedule",
                  title: "Fast Delivery",
                  desc: "Same-day across Lagos",
                },
                {
                  icon: "favorite",
                  title: "Him & Her",
                  desc: "Curated for all genders",
                },
                {
                  icon: "location_on",
                  title: "We Come to You",
                  desc: "Mobile makeup at your venue",
                },
              ].map((f) => (
                <div key={f.title} className="flex gap-3">
                  ...
                  <div>
                    <div className="mb-1 text-[13px] font-semibold text-tle-ink">
                      {f.title}
                    </div>
                    <div className="text-xs leading-snug text-tle-muted">
                      {f.desc}
                    </div>
                  </div>
                </div>
        ...
        {!showSuccess && (
          <section
            className={`${revealCls} px-4 py-20 md:px-16`}
            id="booking-form"
          >
            <div className="mx-auto max-w-[800px]">
              ...
              <div className="relative mb-12 flex">
                {[1, 2, 3, 4].map((i) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-[10.5px] font-semibold tracking-wide uppercase ${stepLabel(i)}`}
                    >
                      {i === 1
                        ? "Service"
                        : i === 2
                  ...
                  <>
                    <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      <p className="text-center text-[13px] leading-relaxed text-tle-muted sm:text-left">
                        Studio photoshoot packages with edited pictures — your
                        makeup session is part of this offer. Tap a card to go
                      ...
                      {PHOTOSHOOT_PACKAGES.map((p) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="mb-1 text-[13.5px] font-semibold leading-snug text-tle-ink">
                              {p.line}
                            </div>
                            <div className="font-sans text-[17px] font-semibold text-tle-gold">
                              {p.price}
                            </div>
                            <p className="mt-2 text-[11.5px] leading-snug text-tle-muted">
                              {s.desc}
                            </p>
                            <p className="mt-3 text-[10px] font-bold uppercase tracking-wide text-tle-pink">
                        ...
                        return (
                          <div
                            ...
                            className={`relative cursor-pointer overflow-hidden rounded-[18px] border-[1.5px] p-5 transition-all ${
                              sel
                                ? "border-tle-pink bg-tle-blush"
                                : "border-black/10 hover:border-tle-pink/40"
                            }`}
                            onClick={() =>
                              setSelectedService({
                                name: s.name,
                ...
                <div className="mt-10 flex items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (!preferredDateIso.trim() || !selectedTime) {
                        setBookingError(
                          "Pick a day on the calendar, then pick a time before continuing.",
                        );
                        return;
                      }
                      goToStep(3);
              ...
              <div className={formStep === 4 ? "block" : "hidden"}>
                <div className="mb-7 rounded-[20px] bg-tle-cream p-7">
                  <p className="mb-4 text-[10.5px] font-bold tracking-wide text-tle-muted uppercase">
                    Booking Summary
                  </p>
                  <div className="flex items-center justify-between border-b border-black/5 py-2.5">
                    <span className="text-[11.5px] font-medium text-tle-muted">
                      Service
                    </span>
                    <span className="text-[13.5px] font-semibold text-tle-ink">
                  ...
                  <div className="mt-1 flex items-center justify-between border-t border-black/10 pt-4">
                    <span className="text-[11.5px] font-bold text-tle-ink">
                      Total
                    </span>
                    <span className="font-sans text-[26px] font-semibold text-tle-gold">
        ...
        >
          ...
          <div className="mb-9 w-full max-w-[480px] rounded-[20px] border border-tle-gold/20 bg-white px-8 py-8">
            {[
              ...
              <div
                key={k}
                className="flex items-center justify-between border-b border-black/5 py-2.5 last:border-0"
              >
                <span className="text-[11.5px] font-medium text-tle-muted">
                  {k}
                </span>
