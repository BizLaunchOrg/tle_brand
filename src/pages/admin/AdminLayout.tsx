...
function AdminLayoutInner() {
   ...
   * navigation from the storefront into admin (and restores the store manifest when leaving).
   */
  useEffect(() => {
      ...
      <div className="flex min-h-svh">
        <aside className={`sticky top-0 hidden h-svh w-[248px] shrink-0 flex-col overflow-hidden border-r lg:flex ${sidebar}`}>
          ...
          <nav className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-3 pb-3 [-ms-overflow-style:auto] [scrollbar-width:thin]">
            ...
            <NavItem to="/admin/appearance" label="Appearance" theme={theme} icon="palette" />
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          >
            ...
            <MobileNavItem to="/admin/appearance" label="Appearance" icon="palette" theme={theme} />
